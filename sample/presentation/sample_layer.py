...
class SampleLayerConfigurationFixture(LayerConfigurationFixture):
    ...
    def layers(self, class_scope=None):
        ...
        return self.parent_fixture.layers() + FixtureList([
            ...
            # LayerConfiguration(
            #     library_keys=[LayerLibraryKey.APPLICATION],
            #     db_entity_key=SampleDbEntityKey.EXISTING_LAND_USE_PARCELS,
            #     visible=True,
            #     column_alias_lookup=dict(land_use_definition__id='land_use_definition_id'),
            #     built_form_set_key='sample_land_use',
            #     layer_style=primary_base_layer_style(SampleLandUseDefinition)
            # ),
