...
from footprint.client.configuration.sample.config_entity.sample_region import SampleDbEntityKey
...
# from footprint.client.configuration.sample.base.sample_existing_land_use_parcel_feature import \
#     SampleExistingLandUseParcelFeature
...
class SampleProjectFixture(ProjectFixture):
    ...
    def default_db_entities(self, **kwargs):
        """
        Project specific additional db_entities
        :param default_dict:
        :return:
        """
        ...
        return super(SampleProjectFixture, self).default_db_entities() + [
